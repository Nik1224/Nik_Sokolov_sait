/**
 * Бегущая строка заказчиков (BUSINESS).
 *
 * Проверяется не вид, а обещания, которые легко потерять при правке стилей:
 * движение начинается само, значит обязано останавливаться (WCAG 2.2.2), а при
 * «уменьшить движение» — не начинаться вовсе, оставляя все названия доступными.
 */
