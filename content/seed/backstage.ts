/**
 * Бэкстейдж со съёмок: свадьбы и портрет.
 *
 ...
 *
 * Постеры сняты не у сервиса: тот подставляет первый кадр, а это обычно пустой
 * зал или размытие. Там, где есть исходник, кадр берётся с него; где его нет —
 * прямо из потока. Секунда записана рядом с каждым: чтобы поменять кадр, ролик
...
export const weddingBackstage: MediaAsset[] = [
  ...
  clip(
    ...
    // Кадр на 33-й секунде. Единственный горизонтальный ролик из пяти.
  ...
  clip(
    '885a95dc',
    '885a95dc-7834-472a-99ac-62fd4b6c987c',
    // Кадр на 15-й секунде.
    { width: 1013, height: 1800, sizes: [...WIDTHS] },
    'Бэкстейдж со свадебной съёмки',
    'Backstage from a wedding shoot',
  ),
...
export const portraitBackstage: MediaAsset[] = [
  clip(
    'eedfabc2',
    'eedfabc2-9bf4-4e27-acd0-406bad33fbbd',
    // Кадр на 19-й секунде. Пока единственный — он же уходит на Home.
    { width: 1013, height: 1800, sizes: [...WIDTHS] },
    'Бэкстейдж с портретной съёмки',
    'Backstage from a portrait shoot',
  ),
];
