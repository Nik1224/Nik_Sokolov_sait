...
export const categories: Category[] = [
  ...
  { _id: 'cat.sport', slug: 'sport', title: { ru: 'Спорт', en: 'Sport' }, description: { ru: 'Тренировки, старты и финалы: съёмка идёт по ходу события и не мешает ни спортсменам, ни судьям.', en: 'Training, starts and finals: filmed as the event runs, without getting in the way of athletes or judges.' }, directions: ['business'], order: 16, videos: kinescopeVideos('sport'), reels: kinescopeReels('sport') },
  { _id: 'cat.food', slug: 'food', title: { ru: 'Еда и кухня', en: 'Food' }, description: { ru: 'Блюдо и процесс: подача крупно, работа на кухне и вертикальные ролики под доставку и меню.', en: 'The dish and the process: plating in close-up, work in the kitchen, vertical clips for delivery apps and menus.' }, directions: ['business'], order: 17, videos: kinescopeVideos('food'), reels: kinescopeReels('food') },
  { _id: 'cat.dance', slug: 'dance', title: { ru: 'Танцы', en: 'Dance' }, description: { ru: 'Движение целиком: номер с опорой на музыку, репетиция и нарезки для студии и соцсетей.', en: 'Movement in full: the routine cut to the music, rehearsals and clips for the studio and social media.' }, directions: ['business'], order: 18, videos: kinescopeVideos('dance'), reels: kinescopeReels('dance') },
  { _id: 'cat.school', slug: 'school', title: { ru: 'Школьные съёмки', en: 'School' }, description: { ru: 'Класс, выпускной и последний звонок: день целиком, без постановочных кадров на камеру.', en: 'The class, the prom and the last bell: the whole day, with nothing staged for the camera.' }, directions: ['private'], order: 19, videos: kinescopeVideos('school'), reels: kinescopeReels('school') },
